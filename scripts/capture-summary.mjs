...
async function capture(path, filename, viewport, theme) {
  ...
  await page.evaluate((selectedTheme) => {
    localStorage.setItem("fa_token", "mock-token-for-screenshot");
...
await capture("/summary", "summary-dark.png", { width: 1440, height: 900 }, "dark");
await capture("/summary", "summary-light.png", { width: 1440, height: 900 }, "light");
await capture("/summary", "summary-mobile-dark.png", { width: 390, height: 1200 }, "dark");
await capture("/summary", "summary-mobile-light.png", { width: 390, height: 1200 }, "light");
