...
const navItems = [
  ...
  { label: "Métodos de pago", href: "/payment-methods", icon: Wallet },
...
export function Sidebar({ mobileOpen, onClose, collapsed, onToggleCollapse }: SidebarProps) {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside
        className={`sticky top-0 hidden h-screen flex-col border-r border-glass-border bg-ground-deep py-5 transition-[width] duration-200 ease-out lg:flex ${
